...
import torch
from switching_optimizers.environment import Environment
from switching_optimizers.eval_functions import eval_agent, eval_handcrafted_optimizer
...
tb_log_dir = 'results/tb_logs/'+config.problem.train+' '+config.policy.optimization_mode
...
def train_and_eval_agent(train_problem_list=train_problem_list,
    ...
    saved_agent_path = 'results/models/trained_agent_' + train_problem_name + '_' + config.environment.reward_system
